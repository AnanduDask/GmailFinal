...
var GmailBox = React.createClass({
  ...
  getLabelWithId: function(labels)
  {
      var accessToken = localStorage.getItem('gToken');
      $.ajax({
       url: 'https://www.googleapis.com/gmail/v1/users/anandudasm1%40gmail.com/messages?labelIds='+labels.labelId+'&maxResults=10&key={AIzaSyD04tC7mwXP3FNSZS6rpqzkfdC46yI6Scg}',
       dataType: 'json',
       type: 'GET',
       beforeSend: function (request)
       {
